  ...
  <div class="home">
    ...
    <main>
      ...
      <div class="right_chart">
        <div id="echart6">
          <div id="right_left1"></div>
          <div id="right_right1"></div>
        </div>
        <div id="echart7">
          <div id="right_left2"></div>
          <div id="right_right2"></div>
        </div>
        <div id="echart8"></div>
      </div>
    </main>
...
export default {
  ...
  methods: {
    async make() {
      // 请求天气接口
      // const { code, data } = await this.$api.getWeather();
      ...
      //   const numList = Object.values(obj);

      this.myChart1 = echarts.init(document.getElementById("echart1"));
      const options = {
        title: {
          text: "【天气统计图】",
          left: "center", //设置标题位置 left 的值可以是像 20 这样的具体像素值，可以是像 '20%' 这样相对于容器高宽的百分比，
          // subtext: "副标题", //副标题文本样式
          // subtextStyle: {},
          textStyle: {
            color: "white",
        ...
        xAxis: {
          type: "value",
          axisLabel: { show: true, textStyle: { color: "#fff" } },//设置x轴信息
        },
        yAxis: {
          inverse: true,
          type: "category",
    ...
    make5() {
      this.myChart6 = echarts.init(document.getElementById("right_left1"));
      const options = {
        title: {
          text: "重点用户关注排行",
          textStyle: {
    ...
    make6() {
      this.myChart7 = echarts.init(document.getElementById("right_right1"));
      const options = {
        legend: {
          top: "bottom",
        },
      ...
      this.myChart7.setOption(options);
    },
    make7() {
      this.myChart7 = echarts.init(document.getElementById("right_left2"));
      const options = {
        title: {
          text: "重点用户关注排行",
          textStyle: {
    ...
    make8() {
      this.myChart8 = echarts.init(document.getElementById("right_right2"));
      const options = {
        title: {
      ...
      this.myChart8.setOption(options);
    },
    make9() {
      this.myChart9 = echarts.init(document.getElementById("echart8"));
      const pathSymbols = {
        reindeer:
      ...
      this.myChart9.setOption(options);
    },
  },
};
</script>
